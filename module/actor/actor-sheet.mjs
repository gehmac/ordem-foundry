export class OrdemActorSheet extends ActorSheet {
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["ordemfoundry", "sheet", "actor"],
      template: "systems/ordemfoundry/templates/actor/actor-sheet.html",
      width: 600,
      height: 820,
      // tabs: [
      //   {
  ...
  /** @override */
  get template() {
    return `systems/ordemfoundry/templates/actor/actor-${this.actor.type}-sheet.html`;
  }
  ...
  getData() {
    ...
    //   // Dropdown
    //   context.optionDegree = CONFIG.ordemfoundry.dropdownDegree;
    //   context.optionClass = CONFIG.ordemfoundry.dropdownClass;
    //   context.optionTrilhas = CONFIG.ordemfoundry.dropdownTrilha;
    //   context.optionOrigins = CONFIG.ordemfoundry.dropdownOrigins;
    ...
    //   const name =
    //     game.i18n.localize("ordemfoundry.newItem") +
    //     " " +
